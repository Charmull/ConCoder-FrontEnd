...
본 프로젝트는 기존 프로젝트에 **유동적인 WebRTC 연결 구조를 적용**하여 참가인원 변화에 따라 최적의 실시간성을 보장하고 다중 접속에 있어서 안정화하고자 하였다.
또한 CRDT 동시 편집 알고리즘을 적용하여 기존 **코드 에디터에 동시성을 극대화**하고자 하였다.
더해서 **동시 편집 화이트보드 기능**을 추가 제공함으로써 더욱 효율적인 코딩 교육이 가능하도록 해,
